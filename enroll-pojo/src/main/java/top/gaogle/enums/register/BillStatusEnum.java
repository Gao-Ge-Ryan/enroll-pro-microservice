...
public enum BillStatusEnum implements IndexedEnum<Integer> {
    ...
    /**
     * 人工处理（收到支付宝通知但不是 {@link top.gaogle.enums.register.AlipayTradeStatusEnum#TRADE_FINISHED}
     * 或 {@link top.gaogle.enums.register.AlipayTradeStatusEnum#TRADE_SUCCESS}）
     */
