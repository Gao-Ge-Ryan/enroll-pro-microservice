...
public class SystemAttributeDTO {
    ...
    public String getAdminBrowserTitle() {
        return adminBrowserTitle;
    }
    ...
    public String getClientBrowserTitle() {
        return clientBrowserTitle;
    }
    ...
    public String getEnterpriseBrowserTitle() {
        return enterpriseBrowserTitle;
    }
    ...
    public String getGonganBeianNumber() {
        return gonganBeianNumber;
    }
    ...
    public String getGonganBeianName() {
        return gonganBeianName;
    }
