...
import top.gaogle.pojo.param.auth.UserQueryParam;
import top.gaogle.pojo.param.register.EnterprisePartnerQueryParam;
...
public interface UserMapper {
    ...
    List<UserModel> testOrderBy(EnterprisePartnerQueryParam queryParam);
}
