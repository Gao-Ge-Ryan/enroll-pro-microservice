...
public class PreAuthorizeAspect {
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(top.gaogle.framework.security.annotation.RequiresLogin) || "
            + "@annotation(top.gaogle.framework.security.annotation.RequiresPermissions) || "
            + "@annotation(top.gaogle.framework.security.annotation.RequiresRoles)";
