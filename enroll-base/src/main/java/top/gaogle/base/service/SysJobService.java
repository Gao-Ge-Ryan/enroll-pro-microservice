...
import top.gaogle.base.common.ScheduleConstants;
import top.gaogle.base.dao.master.SysJobMapper;
import top.gaogle.base.util.CronUtils;
import top.gaogle.base.util.ScheduleUtils;
...
public class SysJobService {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public int deleteJobById(String jobId) throws SchedulerException {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public void updateCronExpressionByJobId(String jobId, String cronExpression) throws SchedulerException {
        SysJob sysJob = jobMapper.selectJobById(jobId);
        if (sysJob != null) {
            String jobGroup = sysJob.getJobGroup();
            // 判断是否存在
            sysJob.setCronExpression(cronExpression);
            sysJob.setUpdateAt(DateUtil.currentTimeMillis());
